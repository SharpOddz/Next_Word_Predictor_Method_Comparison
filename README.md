...
Will compare different types of RNNs: word-level tokenization vs subword-level tokenization vs character-level tokenization and fixed vs dynamic chunk Length.
